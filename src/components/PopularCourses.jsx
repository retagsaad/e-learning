    ...
    <div className="my-10">
      ...
      <div className="md:flex justify-center gap-20 ">
        {heroCourses.map((herocourse) => (
          <div key={herocourse.id} className="bg-indigo-100  shadow-2xl w-80 rounded-2xl  mt-5 ">
              <Image alt='course' src={herocourse.image} width={100} height={100} className="w-full rounded-t-2xl object-cover h-50"/>
